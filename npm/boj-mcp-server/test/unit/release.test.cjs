...
const { DEFAULT_RELEASE_BASE_URL, buildReleaseUrls, normalizeBaseUrl, releaseTag } = require("../../lib/release.cjs");
...
test("buildReleaseUrls creates deterministic URLs", () => {
  ...
  assert.deepEqual(urls, {
    ...
    assetUrl: "https://releases.example.com/download/mcp-server-v0.1.0/boj-mcp-server-x86_64-unknown-linux-gnu.tar.gz",
